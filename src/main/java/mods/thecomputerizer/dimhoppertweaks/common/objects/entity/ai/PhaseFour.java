            ...
            if(this.activeTimer>200) {
                if(!teleported) {
                    ...
                    if(this.chargeStartLag>10) {
                        ...
                        if(this.chargeStartLag==0) this.boss.setAnimation("charge");
                        this.chargeStartLag++;
                    }
                }
            } else {
                if(this.activeTimer==0) this.boss.setAnimation("sword");
                this.activeTimer++;
                ...
                if(this.activeTimer==90) {
                    ...
                    this.boss.world.playSound(null, this.boss.posX, this.boss.posY, this.boss.posZ, SoundEvents.ENTITY_LIGHTNING_THUNDER, SoundCategory.MASTER, 1f, 1f);
                }
