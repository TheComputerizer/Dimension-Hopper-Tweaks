...
public abstract class MixinFlintChunkProvider {
    ...
    @Final @Shadow private final WorldGenerator quartzGen = new WorldGenMinable(((IBlockFlintOre)mcreator_flintOre.block)
            .dimhoppertweaks$getDefaultState(),14,BlockMatcher.forBlock(TechBlocks.flint_block));
    @Final @Shadow private final WorldGenerator magmaGen = new WorldGenMinable(TechBlocks.flint_block.getDefaultState(),
            14,BlockMatcher.forBlock(TechBlocks.flint_block));
}